...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_Time at WorkPunched OutPunched Out Dec _1a06d1'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_Test 2 Bailey Parchment'))
